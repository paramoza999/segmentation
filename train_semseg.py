...
def save_metrics(training_mean_loss, training_accuracy, eval_mean_loss, eval_accuracy, file_path):
    ...
    complete_file_path = os.path.join(file_path, 'metrics.csv')  # Add a filename here
...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default='pointnet_sem_seg_tran_msg', help='model name [default: pointnet_sem_seg]')
    parser.add_argument('--batch_size', type=int, default=16, help='Batch Size during training [default: 16]')
    parser.add_argument('--epoch', default=32, type=int, help='Epoch to run [default: 32]')
    parser.add_argument('--learning_rate', default=0.001, type=float, help='Initial learning rate [default: 0.001]')
    parser.add_argument('--gpu', type=str, default='0', help='GPU to use [default: GPU 0]')
    parser.add_argument('--optimizer', type=str, default='Adam', help='Adam or SGD [default: Adam]')
    parser.add_argument('--log_dir', type=str, default='pointnet_sem_seg_tran_msg', help='Log path [default: None]')
...
def main(args):
    ...
    root = '/home/puoza/p2/Pointnet_Pointnet2_pytorch/stanford'
    NUM_CLASSES = 13
    ...
    for epoch in range(start_epoch, args.epoch):
        ...
        training_mean_loss.append(loss_sum / num_batches)
        training_accuracy.append(total_correct / float(total_seen))
        ...
        with torch.no_grad():
            ...
            eval_mean_loss.append(loss_sum / num_batches)
